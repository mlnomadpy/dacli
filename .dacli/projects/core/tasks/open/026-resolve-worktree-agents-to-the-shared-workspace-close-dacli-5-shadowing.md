...
## Acceptance
- [ ] workspace.Find redirects a linked-worktree cwd to the MAIN worktree .dacli via git-common-dir; new workspace_test proves it
- [ ] spawn --worktree no longer needs to copy the agent file in; a worktree child self-commits AND self-checks boxes against the shared workspace
