...
- task t-01M088WV632VPCXW0Y37P3DSCC (462-agent-report-github-push-retry-can-duplicate-a-task-issue-after-interrupted); status=open; branch=dacli/462-agent-report-github-push-retry-can-duplicate-a-task-issue-after-interrupted; commit=af7a9fd14dbe355481fd7995ca1d6ead768afed3; linked_issue=#682; pending_pr_landing=false
- task t-01M0AEG5AQPVJTH41MJNFRGSSX (464-unify-run-record-writes-so-execution-modes-cannot-silently-lose-audit-artifacts); status=open; branch=dacli/464-unify-run-record-writes-so-execution-modes-cannot-silently-lose-audit-artifacts; commit=f0aa6daaf2bf3a6c613c41fbf1b07457df1991c2; linked_issue=#688; pending_pr_landing=false
## Acceptance
