...
- task t-01M0ZCAQ05J2H9VHB4BA9YTQGD (504-agent-report-accept-ignores-configured-landing-base-after-a-confirmed-merge); status=open; branch=dacli/504-agent-report-accept-ignores-configured-landing-base-after-a-confirmed-merge; commit=none; linked_issue=#791; pending_pr_landing=false
- task t-01M0ZCAQ33YAXPS79D8EJ676KP (505-agent-report-pr-defaults-to-main-instead-of-the-linked-repository-default-branch); status=open; branch=dacli/505-agent-report-pr-defaults-to-main-instead-of-the-linked-repository-default-branch; commit=none; linked_issue=#790; pending_pr_landing=false
## Acceptance
