...
- task t-01M0D2KPMXPN55ASMH9XQXY21J (485-agent-report-spawned-child-task-claims-were-recorded-against-retired-stale); status=open; branch=dacli/485-agent-report-spawned-child-task-claims-were-recorded-against-retired-stale; commit=none; linked_issue=#725; pending_pr_landing=false
- task t-01M0F8DMG5NA6198RGF59NKXWC (491-agent-report-github-sync-dry-run-mutates-by-adopting-issues-before-rejecting); status=open; branch=dacli/491-agent-report-github-sync-dry-run-mutates-by-adopting-issues-before-rejecting; commit=none; linked_issue=#760; pending_pr_landing=false
## Acceptance
