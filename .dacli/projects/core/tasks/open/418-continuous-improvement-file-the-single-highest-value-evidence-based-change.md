...
- task t-01M0F3795JGCAG6ZS3XVAGNS2J (489-agent-report-codex-read-only-spawn-passes-runtime-doctor-but-fails-app-server); status=open; branch=dacli/489-agent-report-codex-read-only-spawn-passes-runtime-doctor-but-fails-app-server; commit=3512622790864ee1cd3d130f62a47e71c10cdf4c; linked_issue=#746; pending_pr_landing=false
## Acceptance
