...
## Acceptance
- [ ] the RO preamble contains no commit/PR instructions and the test asserting it passes on trunk
- [ ] the RW preamble still describes claim-work-commit-pr and the test asserts the difference
## Log
