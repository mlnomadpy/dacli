...
## Acceptance
- [ ] each finding names the exact moment in the lifecycle it hurts: brief assembly, claim, work, record, land, or close
- [ ] at least one finding covers something an agent cannot discover without reading dacli source
- [ ] anything already in the backlog is reported as already filed, not re-filed
- [ ] if a stage is genuinely good, that is stated rather than padded with a finding
## Log
