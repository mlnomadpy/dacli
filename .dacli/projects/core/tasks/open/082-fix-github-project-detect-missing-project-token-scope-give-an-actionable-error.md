...
## Acceptance
- [ ] dacli github project detects gh's 'unknown owner type' (missing project scope) and tells the operator to run 'gh auth refresh -s project' instead of surfacing gh's cryptic message
