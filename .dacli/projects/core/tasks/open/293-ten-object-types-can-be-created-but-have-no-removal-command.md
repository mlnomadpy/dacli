...
## Acceptance
- [ ] each creatable object type either gains a removal inverse or its absence is a documented decision
- [ ] removal refuses when something still references the object, rather than leaving a dangling link
## Log
