...
## Acceptance
- [ ] findings filed with file:line in internal/features/{collab,teamops,knowledge,onboard,queues,shortcuts,skillforge,ghmirror,governance,wscore,selfreport} and internal/skills
## Log
