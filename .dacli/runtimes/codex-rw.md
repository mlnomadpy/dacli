...
invoke_mode: stdin
invoke_args: "[--ask-for-approval, never, exec, --ignore-user-config, --disable, plugins, --disable, plugin_sharing, --disable, remote_plugin, --sandbox, workspace-write, --ephemeral, --color, never, --json]"
