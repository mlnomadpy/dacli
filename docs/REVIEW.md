...
- **Also added**: [docs/README.md](https://github.com/mlnomadpy/dacli/blob/main/docs/README.md) index with per-doc status labels; status headers on SPM/TEAM/SHORTCUTS distinguishing implemented engines from stubbed commands.
