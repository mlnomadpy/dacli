...
|------|---------|-------|------|-------|--------|---------|--------------|
| fixer | v1 | rw | implementer | sonnet |  | apply prompt/doc fixes and commit them | 9 hours ago · workspace: session record — audit findings, agent identities, roles, task states |
| go-auditor | v1 | ro | reviewer | opus |  | audit Go code for performance and best practices | 9 hours ago · workspace: session record — audit findings, agent identities, roles, task states |
| junior | v1 | rw | — | haiku |  | small well-scoped tasks on the cheap model | 29 hours ago · Git/PR discipline in the prompt registry; model tiering and seniority on roles |
