...
func TestShippedMigrationCatalogIsValid(t *testing.T) {
	...
	if len(catalog) != 7 || catalog[0].Version != 1 || catalog[1].Version != 2 || catalog[2].Version != 3 || catalog[3].Version != 4 || catalog[4].Version != 5 || catalog[5].Version != 6 || catalog[6].Version != 7 {
