...
func TestPathsOverlap(t *testing.T) {
	cases := []struct {
		...
		{"a recursive tree claim contains a file", []string{"supabase/**"}, []string{"supabase/config.toml"}, true},
		{"recursive tree containment is symmetric", []string{"supabase/config.toml"}, []string{"supabase/**"}, true},
		{"a recursive tree claim contains deep descendants", []string{"docs/supabase/**"}, []string{"docs/supabase/guides/auth/setup.md"}, true},
		{"a recursive tree claim excludes a sibling prefix", []string{"supabase/**"}, []string{"supabase-old/file.sql"}, false},
		{"an embedded recursive wildcard stays literal", []string{"docs/**/generated"}, []string{"docs/api/generated/file.md"}, false},
		{"a single-star wildcard stays literal", []string{"supabase/*"}, []string{"supabase/config.toml"}, false},
