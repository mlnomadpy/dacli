...
var Commands = []clikit.Command{
	{Path: "shortcut add", Brief: "Define a shortcut", Mutates: true, Usage: "dacli shortcut add <name> --command 'tmpl {{p}}' --effect read|write|destructive [--summary s] [--param name=default]... [--role r]... [--why text]", Run: cmdAdd},
