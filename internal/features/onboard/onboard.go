...
var Commands = []clikit.Command{
	...
	{Path: "new", Brief: "Start a greenfield product: init, project with a filled goal/scope/spec/architecture, detected stack, and a five-task starter backlog", JSON: true, Run: cmdNew},
}
